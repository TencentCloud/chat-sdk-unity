 ...
 * @param user_data ImSDK负责透传的用户自定义数据，未做任何处理
 *
 * @example json_friend_profile_update_array 示例, 具体信息请参考 [FriendProfileItem]()
 * [
 *    {
 ...
 * @param user_data ImSDK负责透传的用户自定义数据，未做任何处理
 *
 * @example json_friend_add_request_pendency_array 示例，json key 请参考 [FriendAddPendency]()
 * [
 *    {
 ...
 * @param user_data ImSDK负责透传的用户自定义数据，未做任何处理
 *
 * @example json_friend_black_added_array 示例。 json key 请参考 [FriendProfile]()
 * [{
 ...
 * 3.1 设置添加好友的回调
 * 
 * @param cb 添加好友回调，请参考[TIMOnAddFriendCallback]()
 ...
 * 3.2 设置删除好友的回调
 * 
 * @param cb 删除好友回调，请参考[TIMOnDeleteFriendCallback]()
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 *
 * @note
 ...
 * 3.3 设置更新好友资料的回调
 * 
 * @param cb 更新好友资料回调，请参考[TIMUpdateFriendProfileCallback]()
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 *
 * @note
 ...
 * 3.4 设置好友添加请求的回调
 * 
 * @param cb 好友添加请求回调，请参考[TIMFriendAddRequestCallback]()
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 *
 * @note
 ...
 * 3.5 设置好友申请被删除的回调
 * 
 * @param cb 好友申请删除回调，请参考[TIMFriendApplicationListDeletedCallback]()
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 *
 * @note
 * 以下四种情况会收到此回调：
 ...
 * 3.6 设置好友申请已读的回调
 * 
 * @param cb 好友申请已读回调，请参考[TIMFriendApplicationListReadCallback]()
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 *
 * @note
 * 如果调用 setFriendApplicationRead 设置好友申请列表已读，会收到这个回调（主要用于多端同步）
 ...
 * 3.7 设置黑名单新增的回调
 * 
 * @param cb 黑名单新增的回调，请参考[TIMFriendBlackListAddedCallback]()
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 */
 ...
 * 3.8 设置黑名单删除的回调
 * 
 * @param cb 黑名单删除的回调，请参考[TIMFriendBlackListDeletedCallback]()
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 */
 ...
 * 4.1 获取好友列表
 *
 * @param cb 获取好友列表成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 ...
 * 4.2 获取指定好友资料
 *
 * @param friend_id_list string array 获取好友的 userid 列表
 * @param cb 获取好友信息的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @example
 ...
 * }]
 */
TIM_DECL int TIMFriendshipGetFriendsInfo(const char *friend_id_list,  TIMCommCallback cb, const void* user_data);

/**
 * 4.3 修改好友资料(备注等)
 *
 * @param json_modify_friend_info_param 更新好友资料接口参数的Json字符串
 * @param cb 更新好友资料成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @note
 * 修改好友资料，目前支持修改的字段请参考[FriendProfileItem]()，一次可修改多个字段。修改自定义字段时填入的key值可以添加 Tag_SNS_Custom_ 前缀，也可以不添加 Tag_SNS_Custom_ 前缀，当不添加时，SDK内部会自动添加该前缀。
 *
 * @example
 ...
 *
 * @param json_search_friends_param 搜索好友的关键字和域，请参考 [FriendSearchParam]()
 * @param cb 搜索好友的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @example
 ...
 * @param cb 添加好友成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @note
 ...
 * @param cb 删除好友成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @note
 ...
 * @param cb 检测好友成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @note
 ...
 * @param cb 获取未决列表成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @note
 ...
 * @param cb 处理好友请求成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @note
 ...
 * @param cb 上报未决信息已读用户成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @example
 ...
 * @param cb 删除指定未决信息成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @example
 ...
 * 6.1 获取黑名单列表
 *
 * @param cb 获取黑名单列表成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 */
 ...
 * @param cb 添加指定用户到黑名单成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @example
 ...
 * @param cb 从黑名单中删除指定用户成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @example
 ...
 * @param cb 创建好友分组成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @note
 ...
 * @param cb 获取好友分组信息成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @example
 ...
 * @param cb 删除好友分组成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @example
 ...
 * @param cb 修改好友分组成功与否的回调。回调函数定义请参考 [TIMCommCallback](TIMCloudDef.h)
 * @param user_data 用户自定义数据，ImSDK只负责传回给回调函数cb，不做任何处理
 * @return int 返回TIM_SUCC表示接口调用成功（接口只有返回TIM_SUCC，回调cb才会被调用），其他值表示接口调用失败。每个返回值的定义请参考 [TIMResult](TIMCloudDef.h)
 *
 * @example
...
/////////////////////////////////////////////////////////////////////////////////
//
//                     八. 好友资料 API 参数相关的 Json Key 定义
//
/////////////////////////////////////////////////////////////////////////////////

//------------------------------------------------------------------------------
// 8.1 FriendProfileCustomStringInfo (好友自定义资料字段)
...
// object [UserProfile](), 只读, 好友的个人资料
static const char* kTIMFriendProfileUserProfile = "friend_profile_user_profile";
// array [FriendProfileCustomStringInfo](), 只读, [自定义好友字段](https://cloud.tencent.com/document/product/269/1501#.E8.87.AA.E5.AE.9A.E4.B9.89.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5)
static const char* kTIMFriendProfileCustomStringArray = "friend_profile_custom_string_array";

//------------------------------------------------------------------------------
// 8.3 FriendProfileItem (好友资料可修改的各个项)
// string, 只写, 修改好友备注
...
// array [FriendProfileCustomStringInfo](), 只写, 修改[自定义好友字段](https://cloud.tencent.com/document/product/269/1501#.E8.87.AA.E5.AE.9A.E4.B9.89.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5)
static const char* kTIMFriendProfileItemCustomStringArray = "friend_profile_item_custom_string_array";

//------------------------------------------------------------------------------
// 8.4 FriendshipModifyFriendProfileParam (修改好友资料接口的参数)
...
// array [FriendAddPendency](), 只读, 好友申请的未决列表， 只有当 change_type 为 kTIMFriendChange_PendencyAdd 时有效
...
// array [FriendProfileUpdate](), 只读, 好友资料更新列表， 只有当 change_type 为 kTIMFriendChange_FriendProfileUpdate 时有效
...
//------------------------------------------------------------------------------
// 9.2 FriendshipDeleteFriendParam (删除好友接口的参数)
// uint [TIMFriendType](), 只写, 删除好友，指定删除的好友类型
...
//------------------------------------------------------------------------------
// 9.3 FriendAddPendency (好友申请未决信息)
...
//------------------------------------------------------------------------------
// 9.4 FriendshipGetPendencyListParam (分页获取好友申请未决信息列表的参数)
// uint [TIMFriendPendencyType](), 只写, 添加好友的未决请求类型
...
//------------------------------------------------------------------------------
// 9.6 FriendAddPendencyInfo (好友申请未决信息)
...
//------------------------------------------------------------------------------
// 9.8 FriendshipDeletePendencyParam (删除好友申请未决信息接口的参数)
// uint [TIMFriendPendencyType](), 只读, 添加好友的未决请求类型
static const char* kTIMFriendshipDeletePendencyParamType = "friendship_delete_pendency_param_type";
// array string, 只读, 删除好友未决请求的UserID列表
static const char* kTIMFriendshipDeletePendencyParamIdentifierArray = "friendship_delete_pendency_param_identifier_array";


/////////////////////////////////////////////////////////////////////////////////
//
//                         十. 检查好友关系 API 参数相关的 Json Key 定义
//
/////////////////////////////////////////////////////////////////////////////////

//------------------------------------------------------------------------------
// 10.1 FriendshipCheckFriendTypeParam (检测好友的类型接口的参数)
// uint [TIMFriendType](), 只写, 要检测的好友类型
...
//------------------------------------------------------------------------------
// 10.1 FriendshipCheckFriendTypeResult (检测好友的类型接口返回)
...
// uint [TIMFriendCheckRelation](), 只读, 检测成功时返回的好友的类型
...
/////////////////////////////////////////////////////////////////////////////////
//
//     十一. 好友操作（添加、删除、加黑名单、添加分组等） API 参数相关的 Json Key 定义
//
/////////////////////////////////////////////////////////////////////////////////

//------------------------------------------------------------------------------
// 11.1 FriendResult (关系链操作接口的返回结果)
...
/////////////////////////////////////////////////////////////////////////////////
//
//                      十二. 好友分组 API 参数相关的 Json Key 定义
//
/////////////////////////////////////////////////////////////////////////////////

//------------------------------------------------------------------------------
// 12.1 CreateFriendGroupParam (创建好友分组接口参数)
...
//------------------------------------------------------------------------------
// 12.3 FriendshipModifyFriendGroupParam (修改好友分组信息的接口参数)
// string, 只写, 要修改的分组名称
...
/////////////////////////////////////////////////////////////////////////////////
//
//                      十三. 好友搜索 API 参数相关的 Json Key 定义
//
/////////////////////////////////////////////////////////////////////////////////

//------------------------------------------------------------------------------
// 13.1 FriendSearchParam (搜索好友的参数)
