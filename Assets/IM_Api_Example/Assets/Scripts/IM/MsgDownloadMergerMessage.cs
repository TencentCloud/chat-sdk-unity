...
public class MsgDownloadMergerMessage : MonoBehaviour
{
  ...
  void MsgDownloadMergerMessageSDK(Message msg)
  {
    TIMResult res = TencentIMSDK.MsgDownloadMergerMessage(msg, Utils.addAsyncStringDataToScreen(GetResult));
  ...
  void GetMessage(params object[] parameters)
  {
    ...
    if (list.Count > 0)
    {
      MsgDownloadMergerMessageSDK(list[0]);
    }
  }
