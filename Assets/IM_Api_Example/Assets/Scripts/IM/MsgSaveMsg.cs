...
public class MsgSaveMsg : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(MsgSaveMsgSDK);
  ...
  void MsgSaveMsgSDK()
  {
    ...
    if (SelectedGroup.value > 0)
    {
      ...
      TIMResult res = TencentIMSDK.MsgSaveMsg(GroupList[SelectedGroup.value], TIMConvType.kTIMConv_Group, message, Utils.addAsyncStringDataToScreen(GetResult));
    ...
    else if (SelectedFriend.value > 0)
    {
      ...
      TIMResult res = TencentIMSDK.MsgSaveMsg(FriendList[SelectedFriend.value], TIMConvType.kTIMConv_C2C, message, Utils.addAsyncStringDataToScreen(GetResult));
      Result.text = Utils.SynchronizeResult(res);
    }
    print(IsOnline.isOn);
    print(IsUnread.isOn);
