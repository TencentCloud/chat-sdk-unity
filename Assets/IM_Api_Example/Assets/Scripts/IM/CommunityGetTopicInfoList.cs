...
public class CommunityGetTopicInfoList : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(CommunityGetTopicInfoListSDK);
  ...
  void CommunityGetTopicInfoListSDK()
  {
    ...
    TIMResult res = TencentIMSDK.CommunityGetTopicInfoList(GroupID.text, topicIDList, Utils.addAsyncStringDataToScreen(GetResult));
