...
public class CommunityDeleteTopicPermissionFromPermissionGroup : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(CommunityDeleteTopicPermissionFromPermissionGroupSDK);
  ...
  void CommunityDeleteTopicPermissionFromPermissionGroupSDK()
  {
    ...
    TIMResult res = TencentIMSDK.CommunityDeleteTopicPermissionFromPermissionGroup(GroupID.text, PermissionGroupID.text, topicIDList, Utils.addAsyncStringDataToScreen(GetResult));
