...
public class GroupDeleteTopicFromCommunity : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(GroupDeleteTopicFromCommunitySDK);
  ...
  void GroupDeleteTopicFromCommunitySDK()
  {
    ...
    TIMResult res = TencentIMSDK.GroupDeleteTopicFromCommunity(group_base_info_group_id, topicIDs, Utils.addAsyncStringDataToScreen(GetResult));
