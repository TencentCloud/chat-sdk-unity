...
public class ConvDeleteConversationsFromGroup : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(ConvDeleteConversationsFromGroupSDK);
  ...
  void ConvDeleteConversationsFromGroupSDK()
  {
    if (ConvList.Count == 0)
    {
      return;
    ...
    TIMResult res = TencentIMSDK.ConvDeleteConversationsFromGroup(GroupName.text, new List<string> {
      conv_id
