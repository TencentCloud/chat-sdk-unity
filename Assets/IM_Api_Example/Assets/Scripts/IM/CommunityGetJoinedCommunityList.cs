...
public class CommunityGetJoinedCommunityList : MonoBehaviour
{
  public Text Header;
  public Text Result;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(CommunityGetJoinedCommunityListSDK);
    Copy.onClick.AddListener(CopyText);
  }

  void CommunityGetJoinedCommunityListSDK()
  {
    ...
    Result.enabled = true;
    TIMResult res = TencentIMSDK.CommunityGetJoinedCommunityList(Utils.addAsyncStringDataToScreen(GetResult));
