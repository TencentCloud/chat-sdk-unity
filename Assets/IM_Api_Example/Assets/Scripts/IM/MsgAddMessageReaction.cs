...
public class MsgAddMessageReaction : MonoBehaviour
{
  public Text Header;
  ...
  void MsgModifyMessageSDK()
  {
    ...
    // 3. 只支持群组消息变更
    TIMResult res = TencentIMSDK.MsgAddMessageReaction(msg,"emoji1" ,Utils.addAsyncStringDataToScreen(GetResult));
