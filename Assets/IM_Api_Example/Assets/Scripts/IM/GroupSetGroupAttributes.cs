...
public class GroupSetGroupAttributes : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(GroupSetGroupAttributesSDK);
  ...
  void GroupSetGroupAttributesSDK()
  {
    ...
    TIMResult res = TencentIMSDK.GroupSetGroupAttributes(groupIDList[SelectedGroup.value], custom_string_array, Utils.addAsyncNullDataToScreen(GetResult));
