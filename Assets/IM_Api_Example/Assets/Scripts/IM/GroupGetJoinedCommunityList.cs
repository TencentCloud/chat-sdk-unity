...
public class GroupGetJoinedCommunityList : MonoBehaviour
{
  public Text Header;
  public Text Result;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(GroupGetJoinedCommunityListSDK);
  ...
  void GroupGetJoinedCommunityListSDK()
  {
    ...
    Result.enabled = true;
    TIMResult res = TencentIMSDK.GroupGetJoinedCommunityList(Utils.addAsyncStringDataToScreen(GetResult));
