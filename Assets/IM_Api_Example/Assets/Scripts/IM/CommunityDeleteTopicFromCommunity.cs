...
public class CommunityDeleteTopicFromCommunity : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(CommunityDeleteTopicFromCommunitySDK);
  ...
  void CommunityDeleteTopicFromCommunitySDK()
  {
    ...
    TIMResult res = TencentIMSDK.CommunityDeleteTopicFromCommunity(GroupID.text, topicIDList, Utils.addAsyncStringDataToScreen(GetResult));
