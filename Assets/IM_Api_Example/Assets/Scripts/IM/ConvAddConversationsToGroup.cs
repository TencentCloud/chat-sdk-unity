...
public class ConvAddConversationsToGroup : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(ConvAddConversationsToGroupSDK);
  ...
  void ConvAddConversationsToGroupSDK()
  {
    if (ConvList.Count == 0)
    {
      return;
    ...
    TIMResult res = TencentIMSDK.ConvAddConversationsToGroup(GroupName.text, new List<string> {
      conv_id
