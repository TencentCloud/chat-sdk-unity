...
public class CommunityGetPermissionGroupListInCommunity : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(CommunityGetPermissionGroupListInCommunitySDK);
  ...
  void CommunityGetPermissionGroupListInCommunitySDK()
  {
    ...
    TIMResult res = TencentIMSDK.CommunityGetPermissionGroupListInCommunity(GroupID.text, permissionGroupIDList, Utils.addAsyncStringDataToScreen(GetResult));
