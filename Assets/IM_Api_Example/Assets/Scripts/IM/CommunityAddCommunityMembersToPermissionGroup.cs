...
public class CommunityAddCommunityMembersToPermissionGroup : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(CommunityAddCommunityMembersToPermissionGroupSDK);
  ...
  void CommunityAddCommunityMembersToPermissionGroupSDK()
  {
    ...
    TIMResult res = TencentIMSDK.CommunityAddCommunityMembersToPermissionGroup(GroupID.text, PermissionGroupID.text, userIDList, Utils.addAsyncStringDataToScreen(GetResult));
