...
public class MsgGetMessageReactions : MonoBehaviour
{
  public Text Header;
  ...
  void MsgModifyMessageSDK()
  {
    ...
    list.Add(msg);
    TIMResult res = TencentIMSDK.MsgGetMessageReactions(list, 10,Utils.addAsyncStringDataToScreen(GetResult));
    // TIMResult res = TencentIMSDK.MsgGetAllUserListOfMessageReaction(msg,"emoji1",1, 10,Utils.addAsyncStringDataToScreen(GetResult));
