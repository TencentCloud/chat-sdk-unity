...
public class MsgImportMsgList : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(MsgImportMsgListSDK);
  ...
  void MsgImportMsgListSDK()
  {
    ...
    if (SelectedGroup.value > 0)
    {
      ...
      TIMResult res = TencentIMSDK.MsgImportMsgList(GroupList[SelectedGroup.value], TIMConvType.kTIMConv_Group, msgList, Utils.addAsyncStringDataToScreen(GetResult));
    ...
    else if (SelectedFriend.value > 0)
    {
      ...
      TIMResult res = TencentIMSDK.MsgImportMsgList(FriendList[SelectedFriend.value], TIMConvType.kTIMConv_C2C, msgList, Utils.addAsyncStringDataToScreen(GetResult));
      Result.text = Utils.SynchronizeResult(res);
    }
    print(IsOnline.isOn);
    print(IsUnread.isOn);
