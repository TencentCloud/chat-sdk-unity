...
public class MsgSetGroupReceiveMessageOpt : MonoBehaviour
{
  ...
  {
    TIMResult res = TencentIMSDK.MsgSetGroupReceiveMessageOpt(Input.text, (TIMReceiveMessageOpt) SelectedRecvOpt.value, Utils.addAsyncStringDataToScreen(GetResult));
