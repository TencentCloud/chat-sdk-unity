...
public class ConvDeleteConversationList : MonoBehaviour
{
  public Text Header;
  ...
  void ConvDeleteSDK()
  {
    ...
    string conv_id = "c2c_"+ConvList[SelectedConv.value].conv_id;
    TIMConvType conv_type = ConvList[SelectedConv.value].conv_type;
    List<string> list = new List<string>();
    list.Add(conv_id);
    TIMResult res = TencentIMSDK.ConvDeleteConversationList(list, false, Utils.addAsyncNullDataToScreen(GetResult));
