...
public class MsgSetLocalCustomData : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(MsgSetLocalCustomDataSDK);
  ...
  void MsgSetLocalCustomDataSDK()
  {
    ...
    if (SelectedGroup.value > 0)
    {
      ...
      TIMResult res = TencentIMSDK.MsgSetLocalCustomData(message, Utils.addAsyncNullDataToScreen(GetResult));
